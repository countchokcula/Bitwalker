...
#include <iostream>
#include "BitAdder.h"
class BitHandler : public BitAdder{

public:
	//Shift bits by rotNum of times
	std::array<std::string, 8> Bitshifter(int rotNum, std::array<unsigned long long, 8> row)
	{
		std::string bin_arr;
	...
	std::array<std::string, 8> Choosing(std::array<unsigned long long, 8>  CHrow, std::array<unsigned long long, 8> row2, std::array<unsigned long long, 8> row3) {
		std::string bin_arr;
		int x = 0;
		std::array<std::string, 8> retarr;
		std::bitset<4> zero(0);
	...
	std::array<unsigned long long, 8>  AddNull(std::array<unsigned long long, 8>  arr) {
	...
	std::array<std::string, 8> Majority(std::array<unsigned long long, 8> A, std::array<unsigned long long, 8> B, std::array<unsigned long long, 8> C) {
